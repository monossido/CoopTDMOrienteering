...
public class MyGeoPoints {
	...
	private void generateEasyPoints() {
		...
		listEasyGeoPoints.add(new GeoPoints(45.276892, 11.678752, "Punto 1", "GUR4V", "Non può mancare in un pic-nic"));
		...
		listEasyGeoPoints.add(new GeoPoints(45.277508, 11.679298, "Punto 10", "3TCT4", "Dai che alla fine sei arrivato ormai, su una porta cercare dovrai"));
